...
const DexCoverage = ({ coverageTypes, types, isLoading, }) => {
    const count = coverageTypes.filter(({ type1, type2 }) => {
        const matchups = types.map((t) => Object(data["d" /* matchupFor */])(type1, type2, t));
        return matchups.some((effectiveness) => {
            return effectiveness > data["a" /* Effectiveness */].REGULAR;
        });
    }).length;
...
function Matchups({ coverageTypes, kind, types, formatTitle, matchups, fallbackCoverageTypes, isLoading, }) {
    return (react["createElement"]("div", { className: "tc pt2", id: `matchup-${kind}` },
        ...
        react["createElement"](Section, { title: formatTitle("4×"), types: matchups.typesFor(data["a" /* Effectiveness */].QUADRUPLE) }),
        react["createElement"](Section, { title: formatTitle("2×"), types: matchups.typesFor(data["a" /* Effectiveness */].DOUBLE) }),
        react["createElement"](Section, { title: formatTitle("1×"), types: matchups.typesFor(data["a" /* Effectiveness */].REGULAR) }),
        react["createElement"](Section, { title: formatTitle("½×"), types: matchups.typesFor(data["a" /* Effectiveness */].HALF) }),
        react["createElement"](Section, { title: formatTitle("¼×"), types: matchups.typesFor(data["a" /* Effectiveness */].QUARTER) }),
        react["createElement"](Section, { title: formatTitle("0×"), types: matchups.typesFor(data["a" /* Effectiveness */].ZERO) })));
}
Matchups.displayName = "Matchups";
function Defense({ type1, type2, fallbackCoverageTypes }) {
    return (react["createElement"](Matchups, { kind: "defense", types: [type1, type2], formatTitle: (x) => `Takes ${x} From`, matchups: Object(data["c" /* defensiveMatchups */])(type1, type2), fallbackCoverageTypes: fallbackCoverageTypes, isLoading: false }));
}
Defense.displayName = "Matchups.Defense";
function Offense({ coverageTypes, types, fallbackCoverageTypes, isLoading, }) {
    return (react["createElement"](Matchups, { kind: "offense", types: types, coverageTypes: coverageTypes, formatTitle: (x) => `Deals ${x} to`, matchups: Object(data["f" /* offensiveMatchups */])(types), fallbackCoverageTypes: fallbackCoverageTypes, isLoading: isLoading }));
}
...
function TypeSelector({ onChange, value, includeNone, disabledTypes, }) {
    const theTypes = includeNone ? data["j" /* typesOrNone */] : data["h" /* types */];
    const styles = {
...
function ScreenDefense({ setDefenseParams, fallbackCoverageTypes, }) {
    ...
    const [type1 = data["b" /* Type */].NORMAL, type2 = data["b" /* Type */].NONE] = Object(data["i" /* typesFromString */])(search.get("types") || "");
    function createParams(types) {
        const params = new URLSearchParams();
        if (types.length >= 0) {
            if (types[1] === data["b" /* Type */].NONE) {
...
function MultiTypeSelector({ onChange, value, }) {
    ...
    return (react["createElement"]("div", { className: "MultiTypeSelector-Container" }, data["h" /* types */].map((type) => {
...
function ScreenOffense({ coverageTypes, setCoverageTypes, setOffenseParams, fallbackCoverageTypes, isLoading, }) {
    const search = useSearch();
    const history = useHistory();
    const offenseTypes = Object(data["i" /* typesFromString */])(search.get("types") || "");
    function createParams(types) {
        const params = new URLSearchParams();
        if (types.length > 0) {
            params.set("types", types.join(" "));
...
// CONCATENATED MODULE: ./src/StatBar.tsx

function StatBar({ value, max, type }) {
    return (react["createElement"]("div", { className: "flex h1 w-100 Bar-Container" },
        react["createElement"]("div", { style: {
                width: (value / max) * 100 + "%",
...
// CONCATENATED MODULE: ./src/StatsTable.tsx



const STAT_MAX = 255;
function StatsTable({ pokemon }) {
    const { hp, attack, defense, spAttack, spDefense, speed } = pokemon;
    return (react["createElement"]("div", { className: "StatsTable tabular-nums" },
        react["createElement"]("div", { className: "b tl" }, "HP"),
        react["createElement"]("div", { className: "tr ph2" }, hp),
        react["createElement"](StatBar, { max: STAT_MAX, value: hp, type: data["b" /* Type */].FIGHTING }),
        react["createElement"]("div", { className: "b tl" }, "Attack"),
        react["createElement"]("div", { className: "tr ph2" }, attack),
        react["createElement"](StatBar, { max: STAT_MAX, value: attack, type: data["b" /* Type */].FIRE }),
        react["createElement"]("div", { className: "b tl" }, "Defense"),
        react["createElement"]("div", { className: "tr ph2" }, defense),
        react["createElement"](StatBar, { max: STAT_MAX, value: defense, type: data["b" /* Type */].ELECTRIC }),
        react["createElement"]("div", { className: "b tl" }, "Sp. Atk."),
        react["createElement"]("div", { className: "tr ph2" }, spAttack),
        react["createElement"](StatBar, { max: STAT_MAX, value: spAttack, type: data["b" /* Type */].GRASS }),
        react["createElement"]("div", { className: "b tl" }, "Sp. Def."),
        react["createElement"]("div", { className: "tr ph2" }, spDefense),
        react["createElement"](StatBar, { max: STAT_MAX, value: spDefense, type: data["b" /* Type */].WATER }),
        react["createElement"]("div", { className: "b tl" }, "Speed"),
        react["createElement"]("div", { className: "tr ph2" }, speed),
        react["createElement"](StatBar, { max: STAT_MAX, value: speed, type: data["b" /* Type */].FAIRY }),
        react["createElement"]("div", { className: "b tl" }, "Total"),
        react["createElement"]("div", { className: "tr ph2", style: { height: 26 } }, hp + attack + defense + spAttack + spDefense + speed),
...
function ScreenPokedex({ allPokemon, setPokedexParams, isLoading, }) {
    ...
    const pkmn = react["useMemo"](() => {
        ...
        const types = Object(data["k" /* typesOrNoneFromString */])(s);
        if (types.length > 0) {
            return searchablePkmn.filter((p) => {
                if (types.length === 1) {
                    return p.types[0] === types[0] || p.types[1] === types[0];
                }
                if (types.length === 2 && types[1] === data["b" /* Type */].NONE) {
    ...
    function saveCSV() {
        const csv = papaparse_min_default.a.unparse({
            ...
            data: fallbackCoverageTypes.map((t) => {
                const type2 = t.type2 === data["b" /* Type */].NONE ? "" : t.type2;
    ...
    async function loadCSV() {
        ...
        const result = papaparse_min_default.a.parse(text, {
            ...
            transform: (value, field) => {
                if (field === "type1") {
                    return Object(data["g" /* stringToType */])(value, data["b" /* Type */].NORMAL);
                }
                if (field === "type2") {
                    return Object(data["g" /* stringToType */])(value, data["b" /* Type */].NONE);
                }
                return value;
            },
        });
        ...
        const newCoverageTypes = result.data.map(data["e" /* objectToCoverageType */]);
